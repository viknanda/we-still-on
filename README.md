...
5. Everyone else opens the same URL, types a name, taps. Names show up quiet under the row they chose. Change your mind by tapping another row (same phone, same person).
...
3. Type another name. Tap **Late** or **Out**. You cannot change the hang line.
